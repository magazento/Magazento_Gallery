...
class Magazento_Gallery_Block_Admin_Category_Edit_Tab_Related extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    protected function _getSelectedProducts()
    {
        ...
        if (!is_array($products)) {
            $id = Mage::app()->getFrontController()->getRequest()->get('category_id');
