...
class Magazento_Gallery_Block_Admin_Category_Edit_Tab_Categories extends Mage_Adminhtml_Block_Catalog_Category_Tree
{
    ...
    {
        parent::__construct();
        $this->setTemplate('magazento_gallery/cattree.phtml');
    }
