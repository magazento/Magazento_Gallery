...
class Magazento_Gallery_Block_Admin_Category_Edit_Tabs extends Mage_Adminhtml_Block_Widget_Tabs {
    ...
    protected function _beforeToHtml() {
        $this->addTab('form_section_category', array(
            ...
            'content' => $this->getLayout()->createBlock('gallery/admin_category_edit_tab_form')->toHtml(),
        ));
        ...
        $this->addTab('form_section_categories', array(
            ...
            'content'   => $this->getLayout()->createBlock('gallery/admin_category_edit_tab_categories')->toHtml(),
        ));               
        ...
        $this->addTab('form_section_page', array(
            ...
            'content'   => $this->getLayout()->createBlock('gallery/admin_category_edit_tab_page')->toHtml(),
        ));               
